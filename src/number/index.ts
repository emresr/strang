  ...
  if (num < 1000) {
    ...
    if (num < 1000000) {
      ...
      if (num < 1000000000) {
        ...
        const forth3: number = each3(Math.floor((num % 1000000000000) / 1000000000));
        if (num < 1000000000000) {
          return forth3 + ' Billion ' + third3 + ' Million ' + second3 + ' Thousand ' + first3;
        } else {
          const fifth3: number = each3(Math.floor((num % 1000000000000000) / 1000000000000));
          return fifth3 + ' Trillion ' + forth3 + ' Billion ' + third3 + ' Million ' + second3 + ' Thousand ' + first3;
        }
      }
    }
  }
